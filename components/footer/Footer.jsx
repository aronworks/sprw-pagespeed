            ...
            <div className="w-5/6 mx-auto text-base font-normal leading-normal text-left text-white ">
                <div className="flex justify-between">
                    ...
                    <div className="flex flex-col">
                        ...
                        <Link href="/">
                            <a className="mb-3 p-2">Learn Android For  <span className="text-blue-500 underline">Free</span>  </a>
                        </Link>
                        <Link href="/">
                            <a className="mb-3 p-2">Learn Scratch Programming For<span className="text-blue-500 underline">Free </span> </a>
                        </Link>
                        <Link href="/">
                ...
                <div>
                    <div className="my-4 p-2 w-[356px]">
                        <span className="font-medium text-lg mb-4 ">Subscribe News letter</span>
                        <div>
                            <input type="email" placeholder="Enter e-mail address" className="bg-white text-gray-900 h-12 px-5 leading-10 w-8/12" />
